                ...
                <CollapsibleTrigger asChild>
                  <CardHeader className="group relative flex cursor-pointer flex-row items-center justify-between space-y-0 py-6">
                    <div className="relative z-10 flex flex-col gap-1">
                      <span className="text-[10px] leading-none font-black tracking-widest text-primary uppercase">
                        {session.planName}
                      </span>
                      <CardTitle className="mt-1 text-2xl leading-none font-black tracking-tighter italic">
                    ...
                    <div className="relative z-10 flex flex-col items-end gap-2">
                      ...
                      <ChevronDown
                        className={cn(
                          ...
                          openWorkouts[session.id] && 'rotate-180',
                        )}
                      />
                    </div>
